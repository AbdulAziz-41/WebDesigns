...
export default function WhyFilmBannar() {
        ...
        <section className="max-w-[1440px] mx-auto">
          <div className="text-center  py-20 px-10 sm:px-20 md:px-28 lg:px-40  flex flex-col items-center gap-4 sm:gap-14 md:gap-28 lg:gap-[150px] ">
            <div className="flex flex-col items-center">
              <span
                className="font-combon italic  text-[30px] sm:text-[45px] md:text-[60px] lg:tracking-[-0.07em] lg:text-[72px]
 text-white leading-[50px] sm:leading-[66.96px] tracking-[-0.07em]
 font-light"
              >
 ...
 text-white leading-[50px] lg:leading-[66.96px] tracking-[-0.07em]
 font-light"
              >
