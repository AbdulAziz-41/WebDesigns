...
export default function AboutPageBannar() {
  return (
    <div className="bg-[#1D1D1D]">
      <div className="max-w-[1440px] mx-auto pt-[169px]">
        <div className="px-5 sm:px-9 md:px-16 lg:px-[93px] text-center text-white ">
          <h1 className="font-combon font-light  italic text-[88px] leading-[81.8px] tracking-[-0.07em] pb-10">
            Our mission is to make film &nbsp;
            <span className="italic font-normal">investable</span>
          </h1>
          <p className="px-60 font-normal text-[24px] leading-[40.8px] text-center tracking-[-0.05em]">
